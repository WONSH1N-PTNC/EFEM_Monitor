...
| **S7.5-c** | Maintenance — 영점 교정 · 수동 조작 · Homing | 8시간 연속 UI 응답성/메모리 누수 |
...
2. **S7.5-c — 잔여 화면.** Maintenance(영점 교정·수동 Jog·파라미터 실시간 조정·고속 로거),
   Data Log. I/O Status 는 **S7.5-a**, 알람 설정은 **S7.5-b** 로 완료했습니다.
